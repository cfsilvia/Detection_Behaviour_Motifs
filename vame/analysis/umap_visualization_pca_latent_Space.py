...
class umap_visualization_pca_latent_Space:
    def __init__(self,config,exp_file = None ):
       ...
       self.file_latent_vector = os.path.join(self.project_path,"results", exp_file, "pca_latent_vector_latent_vector_" +self.file_exp[0] + '.npy' )
       self.save_data = os.path.join(cfg['project_path'],"results",exp_file,"")
       self.file_labels = os.path.join(self.project_path,"results", exp_file, "hmm_labels_latent_vector_" + self.file_exp[0] + '.npy')
       self.umap_without_labels = os.path.join(self.save_data,str(self.n_cluster)+'_umap_without_label_number_'+ self.file_exp[0] + '.pdf')
       self.umap_with_labels = os.path.join(self.save_data,str(self.n_cluster)+'_umap_with_label_number_'+ self.file_exp[0] + '.pdf')
       self.umap_without_motifs = os.path.join(self.save_data,str(self.n_cluster)+'_umap_without_motifs_'+ self.file_exp[0] + '.pdf') 
